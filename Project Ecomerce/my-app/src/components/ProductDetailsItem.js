                ...
                <div className="single_product_desc">
                  ...
                  <div className="cart--area d-flex flex-wrap align-items-center">
                    ...
                    <form className="cart clearfix d-flex align-items-center" method="post">
                      <div >
                        <span style={{fontSize:'18px'}} className="qty font-weight-bold">{item.quantity} </span>
                        <div className="btn-group radio-group ml-2" data-toggle="buttons">
                          <label style={{ backgroundColor: '#f5f5f5' }} onClick={() => this.onUpdateQuantity(item.product, item.quantity - 1)} className="btn btn-sm btn-rounded waves-effect waves-light">
                            <a style={{fontSize:'24px'}} className='font-weight-bold' href="#/"> - </a>
                          </label>
                          <label style={{ backgroundColor: '#f5f5f5' }} onClick={() => this.onUpdateQuantity(item.product, item.quantity + 1)} className="btn btn-sm btn-rounded waves-effect waves-light">
                            <a style={{fontSize:'24px'}} href="#/"> + </a>
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="wishlist-compare d-flex flex-wrap align-items-center">
                      <a href="#/" className="wishlist-btn ml-15"><i className="far fa-heart" /></a>
                      <a href={item.product.image} className="compare-btn ml-15"><i className="fas fa-search" /></a>
                    </div>
                  </div>
